...
export function SmartTools({ cloud, workOrders, onVehicleDecoded }: Props) {
  ...
  return <div className="page smart-page"><div className="page-title"><div><p className="eyebrow">智能工具中心</p><h2>AI、VIN、OCR 与客户服务</h2></div><span className="version-chip">v0.82.3</span></div>
