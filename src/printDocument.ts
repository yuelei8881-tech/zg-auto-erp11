...
<div class="print-actions"><strong>打印设置中请关闭“页眉和页脚”；系统已自带公司网址和页码</strong><button class="back" type="button" onclick="returnToOrder()">← 返回工单</button><button type="button" onclick="window.print()">开始打印</button></div>
