...
<div class="signatures"><div class="sig">${signed}<b>Customer Signature / Date · 客户签字/日期</b></div><div class="sig"><b>Authorized By / Date · 授权人/日期</b></div></div><div class="footer">${escapeHtml(settings.invoiceTerms || 'Thank you for your business.')}</div>
