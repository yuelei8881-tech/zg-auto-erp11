...
const copy = {
  zh: {
    eyebrow: 'Z&G 保养奖励计划', title: '5 次保养，送 1 次免费保养', subtitle: '并赠送“更换刹车油”或者“清洗燃油系统”二选一。使用嘉实多 Castrol 5W-30，按需添加防冻液和玻璃水，并包含 7 项免费检查。每辆车单独累计。', price: '常规价格：每次 $100', location: '319 Agostino Rd, San Gabriel, CA 91776 · 626-508-0888',
