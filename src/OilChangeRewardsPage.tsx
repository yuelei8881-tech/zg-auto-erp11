...
const copy = {
  zh: {
    eyebrow: 'Z&G 保养奖励计划', title: '5 次保养，送 1 次保养', subtitle: '使用嘉实多 Castrol 5W-30，按需添加防冻液和玻璃水，并包含 7 项免费检查。第 6 次再送“清洗燃油系统”或“更换刹车油”二选一。每辆车单独累计。', price: '常规价格：每次 $100', location: '319 Agostino Rd, San Gabriel, CA 91776 · 626-508-0888',
...
function ProgramTerms() {
  return <div className="reward-terms-copy">
    <section lang="zh"><h3>中文活动条款</h3><ol>
      <li>本活动常规保养价格为每次 $100。客户成功登记后，每辆登记车辆完成五次符合条件的付费保养，可获得同一车辆第六次同等保养免费，并可在“清洗燃油系统”或“更换刹车油”中选择一项作为当次免费附加服务；两项不可同时兑换。不同车辆的次数不得合并或转让。</li>
      ...
      <li>“清洗燃油系统”或“更换刹车油”的免费二选一项目仅限与第六次奖励保养同时使用，并须经到店检查确认车辆适用；不得拆分、延期、兑换现金或替换为其他服务。免费项目限本店标准服务范围，超出标准范围的额外材料或维修须另行报价并经客户批准。</li>
    ...
    <section lang="en"><h3>English Program Terms (Controlling Version)</h3><ol>
      <li>The regular program price is $100 per maintenance service. After successful enrollment, each registered vehicle earns one complimentary sixth maintenance service after five qualifying paid maintenance services, plus a choice of one complimentary add-on with that sixth service: fuel-system cleaning or brake-fluid replacement. Both add-ons may not be redeemed together. Progress is vehicle-specific and may not be combined or transferred.</li>
      ...
      <li>The choice of complimentary fuel-system cleaning or brake-fluid replacement must be used with the sixth reward service and is subject to inspection and vehicle eligibility. It may not be split, deferred, exchanged for cash, or substituted for another service. The add-on is limited to the shop's standard service; additional materials or repairs outside that scope require a separate estimate and customer approval.</li>
