...
const copy = {
  zh: {
    eyebrow: 'Z&G 保养奖励计划', title: '5 次保养，送第 6 次免费保养', subtitle: '使用嘉实多 Castrol 5W-30，按需添加防冻液和玻璃水，并包含 7 项免费检查。每辆车单独累计。', price: '常规价格：每次 $100', location: '319 Agostino Rd, San Gabriel, CA 91776 · 626-508-0888',
    ...
    submit: '登记参加活动', submitting: '正在安全提交…', success: '登记已收到', successText: '我们会核对客户与车辆资料。通过后，登记日期之后符合条件的保养将按车辆分别累计；完成 5 次后，第 6 次同等保养免费。', existingSuccess: '老客户注册成功', existingSuccessText: '系统已匹配到您的老客户车辆，车辆已自动加入保养活动，并自动累计第 1 次保养记录。以后重复提交同一车辆只会打开原有进度，不会重复增加次数。', saveLink: '请保存您的专属进度查询链接', copyLink: '复制链接', copied: '已复制', error: '提交失败，请检查资料后重试。',
  },
  en: {
    eyebrow: 'Z&G Maintenance Rewards', title: 'Complete 5 services. Get the 6th maintenance service free.', subtitle: 'Uses Castrol 5W-30, includes coolant and windshield-washer fluid top-offs as needed, and includes 7 complimentary inspections. Progress is tracked separately for each vehicle.', price: 'Regular price: $100 per service', location: '319 Agostino Rd, San Gabriel, CA 91776 · 626-508-0888',
