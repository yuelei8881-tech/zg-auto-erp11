...
const copy = {
  zh: {
    ...
    submit: '登记参加活动', submitting: '正在安全提交…', success: '登记已收到', successText: '我们会核对客户与车辆资料。通过后，登记日期之后符合条件的保养将按车辆分别累计；完成 5 次后，第 6 次同等保养免费。', existingSuccess: '老客户车辆已自动加入', existingSuccessText: '作为老客户，您的车辆已经自动添加到活动系统，并已自动累计 1 次保养记录。系统已为您打开现有活动进度，不会重复累计。', saveLink: '请保存您的专属进度查询链接', copyLink: '复制链接', copied: '已复制', error: '提交失败，请检查资料后重试。',
  },
  en: {
